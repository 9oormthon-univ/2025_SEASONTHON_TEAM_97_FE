...
const Dashboard = () => {
  ...
  return (
    <div className="p-5 md:p-6 lg:p-8 bg-gray-50 min-h-screen font-sans">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-7 md:mb-8 px-2">
      ...
      {/* 캘린더 섹션 */}
      <div className="bg-white rounded-xl p-4 md:p-5 lg:p-6 mb-7 md:mb-8 shadow-lg">
        {/* 요일 헤더 */}
              ...
              {day && (
                <>
                  ...
                  <div className="w-full flex flex-col gap-0.5">
                    {/* 특정 날짜에 이벤트 표시 (예시) */}
                    {day >= 3 && day <= 6 && (
                      <div className="bg-green-500 text-white text-[8px] md:text-[9px] lg:text-[10px] px-1 py-0.5 rounded-sm text-center whitespace-nowrap overflow-hidden text-ellipsis min-h-[14px] md:min-h-[16px] flex items-center justify-center">
                        {/* 빈 이벤트 바 */}
                      </div>
                    )}
                    {day === 8 && (
      ...
      {/* 레이더 차트 섹션 */}
      <div className="bg-white rounded-xl p-4 md:p-5 lg:p-6 shadow-lg">
            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
              {categories.map((category, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="absolute text-[9px] md:text-[10px] lg:text-xs text-gray-600 font-medium text-center whitespace-nowrap transform -translate-x-1/2 -translate-y-1/2"
                    style={{
                      left: `${x}px`,
                      top: `${y}px`,
                    }}
